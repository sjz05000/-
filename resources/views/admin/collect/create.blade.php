...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
    	<form class="mws-form" action="/admin/collect" method="post">
    		{{csrf_field()}}
    		<div class="mws-form-inline">
    			...
    			<div class="mws-form-row">
    				...
    				<div class="mws-form-item">
    					<input type="text" class="medium" name="title" value="">
    				</div>
    			</div>
    		<!-- 	<div class="mws-form-row">
    				...
    				<div class="mws-form-item">
    					加载编辑器的容器
					    <script id="container" name="content" class="medium" type="text/plain">
					    </script>
    				</div>
    			</div> -->
    		</div>
