	...
	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
                        	<form action="/admin/advertisements" method="get">
                        	<div id="DataTables_Table_1_length" class="dataTables_length">
                        	<label>显示
                        	<select size="1" name="show_page" aria-controls="DataTables_Table_1">
                        	...
                        	<div class="dataTables_filter" id="DataTables_Table_1_filter">
                        		<label>名称: <input type="text" aria-controls="DataTables_Table_1" name="adname" value="{{$request['adname'] or ''}}"></label>
                        ...
                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                        	...
                        	<tr class="odd">
                                    ...
                                    <td class="  sorting_1">{{$v->adname}}</td>
                                    <td class="  sorting_1">{{$v->adphone}}</td>
                                    <td class="  sorting_1"><img src="{{$v->adfile}}" style="width:100px;height: 70px"></td>
                                    <td class="  sorting_1">{{$v->status==1 ? '激活' : '未激活'}}</td>
                                    <td class="  sorting_1">{{$v->url}}</td>
                                    <td class="  sorting_1">{{$v->created_at}}</td>
                                    <td class="  sorting_1">
                                    	<a href="/admin/advertisements/{{$v->id}}/edit" class="btn btn-info" >修改</a>
                                    	<form action="/admin/advertisements/{{$v->id}}" method="post" style="display: inline-block;">
